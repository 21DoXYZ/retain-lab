...
против ToS Meta: сессию могут забанить, банят ЛИЧНЫЙ номер клиента. Поэтому:
  ...
  2. автокасания выключены ПО УМОЛЧАНИЮ и включаются вторым явным тумблером
     (wa_personal_automation, решение владельца 2026-08-13) с дневным
     бюджетом номера (wa_personal_daily_cap, деф. 20) - массовой рассылки
     с личного номера не бывает физически; сендер - бюджетная ветка
     send_whatsapp в saas_senders, этот модуль отдаёт ей reply_as_human;
