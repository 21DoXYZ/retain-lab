> For the complete documentation index, see [llms.txt](https://docs.mico.team/X5jRoDnFziWouDZp5RQv/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.mico.team/X5jRoDnFziWouDZp5RQv/game-recommender/s3-data-ingestion.md).
...
| Dataset | Ingest Type | Description                      |
| ------- | ----------- | -------------------------------- |
| `bets`  | `__append`  | Raw bet log, incremental by date |
| `users` | `__reload`  | Full snapshot of player profiles |
