...
Scopes define what operations your access token can perform. They follow a three-level structure:

```
<product>:<resource>:<action>
```

**Example:** `vip-intelligence:data:write`

* **Product:** `vip-intelligence` (VIP Intelligence)
* **Resource:** `data` (data upload operations)
* **Action:** `write` (upload permission)

### Available Scopes

<table data-full-width="true"><thead><tr><th width="289.34765625">Scope</th><th>Product</th><th width="627.07421875">Permission</th></tr></thead><tbody><tr><td><code>vip-intelligence:data:write</code></td><td>VIP Intelligence</td><td>Upload data for VIP Intelligence models</td></tr><tr><td><code>vip-intelligence:results:read</code></td><td>VIP Intelligence</td><td>Read VIP Intelligence predictions</td></tr><tr><td><code>game-recommender:data:write</code></td><td>Game Recommender</td><td>Upload data for Recommender models</td></tr><tr><td><code>game-recommender:results:read</code></td><td>Game Recommender</td><td>Read game recommendations</td></tr></tbody></table>
...
### VIP Intelligence Only

Request scopes: `vip-intelligence:data:write`, `vip-intelligence:results:read`

Available operations:

* Upload betting, user, payment data
* Get VIP predictions
...
#### VIP Intelligence Endpoints

<table data-full-width="true"><thead><tr><th width="414.8359375">Endpoint Pattern</th><th>Required Scope</th></tr></thead><tbody><tr><td><code>GET /v1/predictions/previp</code></td><td><code>vip-intelligence:results:read</code></td></tr><tr><td><code>GET /v1/predictions/previp/date/{date}</code></td><td><code>vip-intelligence:results:read</code></td></tr><tr><td><code>GET /v1/predictions/previp/user/{user_id}</code></td><td><code>vip-intelligence:results:read</code></td></tr><tr><td><code>GET /v1/predictions/vip-churn</code></td><td><code>vip-intelligence:results:read</code></td></tr><tr><td><code>GET /v1/predictions/vip-churn/date/{date}</code></td><td><code>vip-intelligence:results:read</code></td></tr><tr><td><code>GET /v1/predictions/vip-churn/user/{user_id}</code></td><td><code>vip-intelligence:results:read</code></td></tr><tr><td><code>GET /v1/predictions/stable-vip</code></td><td><code>vip-intelligence:results:read</code></td></tr><tr><td><code>GET /v1/predictions/stable-vip/date/{date}</code></td><td><code>vip-intelligence:results:read</code></td></tr><tr><td><code>GET /v1/predictions/stable-vip/user/{user_id}</code></td><td><code>vip-intelligence:results:read</code></td></tr></tbody></table>

All VIP Intelligence prediction endpoints require the same scope.
...
```bash
scope=vip-intelligence:data:write
```

**Production API (read only):**

```bash
scope=vip-intelligence:results:read
```
