...
(function () {
  ...
  try {
    ...
    // баннер (несписание случается ПОСЛЕ загрузки страницы). 90 секунд, чтобы
    // касание «человек сейчас онлайн - шлём in-app» догоняло его посреди
    // сессии; ~3-4 запроса на окно rate-limit (60/5мин) - с большим запасом.
    setInterval(function () {
