...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { key: "launches", href: "/launches", emoji: "🚀", label: "nav.launches",
        roles: ["super_admin", "head_retention", "director", "analyst", "finance", "marketing_manager"] },
      { key: "money", href: "/money", emoji: "💵", label: "nav.money",
        roles: ["super_admin", "head_retention", "director", "analyst", "finance", "marketing_manager"] },
      { key: "retention", href: "/retention", emoji: "🛟", label: "nav.retention",
        roles: ["super_admin", "head_retention", "director", "analyst", "finance", "marketing_manager"] },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "users", href: "/users", emoji: "👥", label: "nav.players", roles: [...ANALYSTS, "finance", "support"] },
      // Инбокс личного WhatsApp (трек C): живой человек отвечает клиентам
      { key: "wa-inbox", href: "/wa-inbox", emoji: "💬", label: "nav.waInbox", roles: [...ANALYSTS, "finance", "support"] },
