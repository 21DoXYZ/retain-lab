...
export const saas: Partial<Messages> = {
  ...
  "saas.home.machine.body":
    "{active} users in campaigns · {holdout} in holdout · {touches} touches in 7 days · dry-run mode (no touches leave until you enable autopilot)",
  ...
  "saas.offers.col.issued": "Issued (incl. dry)",
  ...
  "saas.q.lead": "Answer 6 questions - the system composes a starter offer set for your product using transparent rules (plus AI when the key is connected). Everything is editable later on the Offers screen.",
