...
export const saas: Partial<Messages> = {
  ...
  "saas.ob.offers.desc": "These are what campaigns hand out: bonus units, a discount, extra trial days. Check the generosity and the limits - or tune them on the Offers screen.",
  ...
  "saas.q.lead": "Answer nine questions - the system composes a starter set of offers for your product using transparent rules (and AI when the key is connected). Everything can be adjusted later on the Offers screen.",
